...
<!-- Products 1A -->
@php
    $title_session1a = explode ( ',' , getFieldPage('home.title_session1a'));
    $cate_slug_session1a = explode ( ',' , getFieldPage('home.cate_slug_session1a'));
@endphp
<section id="aa-product-a">
                            ...
                            <!-- Start men product category -->
                                ...
                                <div class="tab-pane fade in active" id="men">
                                    ...
                                    <ul class="aa-product-catg">
                                        ...
                                        @foreach($cate_slug_session1a as $key => $cate)
