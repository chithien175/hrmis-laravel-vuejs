            ...
            <div class="card mb-2">
                <div class="card-header">
                    <div class="group-btns pull-right">
                        <a href="{{ route('log-viewer::logs.download', [$log->date]) }}" class="btn btn-sm btn-success" style="font-size: 11px;">
                            <i class="fa fa-download"></i> Tải xuống
                        </a>
                        <a href="#delete-log-modal" class="btn btn-sm btn-danger" data-toggle="modal" style="font-size: 11px;">
                    ...
                    <form action="{{ route('log-viewer::logs.search', [$log->date, $level]) }}" method="GET">
                        <div class="form-group">
                            <div class="input-group">
                                <input id="query" name="query" class="form-control"  value="{!! $query !!}" placeholder="Nhập vào để tìm kiếm" style="font-size: 11px;">
                        ...
                        <tbody>
                            @forelse($entries as $key => $entry)
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        @if ($entry->hasStack())
                                            <a class="btn btn-sm btn-light" role="button" data-toggle="collapse" href="#log-stack-{{ $key }}" aria-expanded="false" aria-controls="log-stack-{{ $key }}" style="font-size: 11px;">
