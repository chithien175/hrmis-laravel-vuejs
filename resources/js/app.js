...
const routes = [
    ...
    { path: '/admin/media', component: require('./components/media/MediaComponent.vue').default },
    { path: '/admin/gallery', component: require('./components/gallery/GalleryComponent.vue').default },
