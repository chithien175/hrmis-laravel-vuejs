...
export default {
    ...
    data() {
        return {
            ...
            categories: {},
            form: new Form({
                id: '', title: '', slug: '', photo: 'post-image-default.jpg', description: '', body: '', publish: 'publish', counter: 0, user_id: '', checked_categories: [], seo_title: '', seo_description: '', seo_keyword: ''
            }),
            search: '',
            isLoading: true,
        }
